...
namespace HNUDIP
{
    static class ImageProcess
    {
        ...
        public static void SetPixel(Bitmap bmp, int x, int y, Color color)
        {
            ...
            // Compute the starting index of the pixel
            int index = y * stride + x * bytesPerPixel;

            // Set the pixel value
            unsafe
            {
                byte* pixel = (byte*)bmpData.Scan0 + index;
                pixel[0] = color.B;
                pixel[1] = color.G;
                pixel[2] = color.R;
            }
        ...
        public static Color GetPixel(Bitmap bmp, int x, int y)
        {
            ...
            Marshal.Copy(IntPtr.Add(bmpData.Scan0, index), pixelValues, 0, 3);

            bmp.UnlockBits(bmpData);

            return Color.FromArgb(pixelValues[2], pixelValues[1], pixelValues[0]);
        }
